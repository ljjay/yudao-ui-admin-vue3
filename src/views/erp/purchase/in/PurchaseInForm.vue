<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="1440" :fullscreen="true">
    <el-form
      ref="formRef"
      :model="formData"
      :rules="formRules"
...
const openPurchaseOrderInEnableList = async () => {
  ...
  purchaseOrderInEnableListRef.value.open(formData.value.deptId)
}
